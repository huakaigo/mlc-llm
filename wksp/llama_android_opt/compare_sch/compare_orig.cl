...
__kernel void fused_decode1_fused_NT_matmul2_silu_after_kernel(__global uint* restrict lv36, __global half* restrict lv37, __global half* restrict lv45, __global half* restrict p_output0_intermediate, int n) {
  ...
  for (int k_0 = 0; k_0 < 128; ++k_0) {
    lv37_local[0] = vload8(0, lv37 + (((k_0 * 11008) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)));
    for (int k_1 = 0; k_1 < 4; ++k_1) {
      lv36_local[0] = vload8(0, lv36 + ((((k_0 * 44032) + (k_1 * 11008)) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)));
  ...
  for (int ax1_1 = 0; ax1_1 < 4; ++ax1_1) {
    if (((((convert_int(get_group_id(1))) * 32) + ((convert_int(get_local_id(1))) * 4)) + ax1_1) < n) {
      vstore8((var_NT_matmul_intermediate_pad_local[ax1_1] * (((half8)((half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f)) / (((half8)((half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f, (half)1.000000e+00f)) + exp((((half8)((half)0.000000e+00f, (half)0.000000e+00f, (half)0.000000e+00f, (half)0.000000e+00f, (half)0.000000e+00f, (half)0.000000e+00f, (half)0.000000e+00f, (half)0.000000e+00f)) - var_NT_matmul_intermediate_pad_local[ax1_1]))))), 0, p_output0_intermediate + ((((((convert_int(get_group_id(1))) * 352256) + ((convert_int(get_local_id(1))) * 44032)) + (ax1_1 * 11008)) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)));
    }
  }
}
